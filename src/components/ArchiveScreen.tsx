                            ...
                            <View style={styles.avatarRow}>
                                <View style={styles.avatarWrap}>
                                    {avatarStr.length > 2 ? (
                                        ...
                                        <Text style={{ fontSize: 13, color: colors.switchThumb, fontWeight: 'bold' }}>
        ...
        <View style={[styles.container, { paddingBottom: bottomPadding }]}>
            ...
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    ...
                    >
                        <SlidersHorizontal size={18} color={showFilter ? '#a78bfa' : colors.textSecondary} />
                    </TouchableOpacity>
                </View>
                ...
                {showFilter && (
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filtersRow}>
                        ...
                        >
                            <Text style={[styles.filterChipText, activeFilter === 'all' && { color: colors.textPrimary, fontWeight: 'bold' }]}>Tümü</Text>
                        </TouchableOpacity>
